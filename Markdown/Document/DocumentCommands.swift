    ...
    var body: some Commands {
        CommandGroup(replacing: .saveItem) {
            ...
            Button("Exporter en PDF…") {
                MarkdownEditorActionDispatcher.send(MarkdownFormattingCatalog.exportPDFAction.selector)
            }
            .keyboardShortcut(
                MarkdownFormattingCatalog.exportPDFAction.keyboardShortcut ?? "E",
                modifiers: MarkdownFormattingCatalog.exportPDFAction.keyboardModifiers
            )
